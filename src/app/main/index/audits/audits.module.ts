...
import { SearchAuditsComponent } from './all-audits/search-audits/search-audits.component';
...
@NgModule({
  declarations: [AuditsComponent, AllAuditsComponent, SearchAuditsComponent],
  imports: [
    CommonModule,
    AuditsRoutingModule,
    FormsModule,
